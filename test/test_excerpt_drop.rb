...
class TestExcerptDrop < BuntoUnitTest
  context "an excerpt drop" do
    ...
    should "have the right thing" do
      ...
      assert @doc_drop.is_a? Bunto::Drops::DocumentDrop
      assert @excerpt.is_a? Bunto::Excerpt
      assert @excerpt_drop.is_a? Bunto::Drops::ExcerptDrop
    end
