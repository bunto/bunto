  ...
  context "An extracted excerpt" do
    ...
    context "#to_liquid" do
      should "contain the proper page data to mimick the post liquid" do
        ...
        assert_equal %w[first second third bunto.isc], @excerpt.to_liquid["tags"]
    ...
    context "#content" do
      ...
      context "after render" do
        ...
        should "be the first paragraph of the page" do
          assert_equal "<p>First paragraph with <a href=\"http://www.bunto.isc/\">link ref</a>.</p>\n\n", @extracted_excerpt.output
        end

        should "link properly" do
          assert @extracted_excerpt.content.include?("http://www.bunto.isc/")
        end
      end
    end
  end
