...
class TestDocument < BuntoUnitTest
  ...
  context "documents in a collection with custom title permalinks" do
    ...
    should "produce the right URL if they have a wild slug" do
      assert_equal "/slides/Well,-so-what-is-Bunto,-then", @document_with_strange_slug.url
    end
  ...
  context "a static file in a collection" do
    setup do
      ...
      @site.process
      @document = @site.collections["slides"].files.find { |doc| doc.relative_path == "_slides/octobunto.png" }
