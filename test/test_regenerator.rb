...
class TestRegenerator < BuntoUnitTest
  ...
  context "The site metadata" do
    ...
    should "write to the metadata file" do
      ...
      @regenerator.write_metadata
      assert File.file?(source_dir(".bunto-metadata"))
    end
  ...
  context "when incremental regen is disabled" do
    ...
    should "not create .bunto-metadata" do
      refute File.file?(source_dir(".bunto-metadata"))
    end
  end
end
