...
class TestCollections < BuntoUnitTest
  context "an evil collection" do
    setup do
      @collection = Bunto::Collection.new(fixture_site, "../../etc/password")
    end
  ...
  context "a simple collection" do
    setup do
      @collection = Bunto::Collection.new(fixture_site, "methods")
    end
  ...
  context "with a collection" do
    ...
    should "create a Hash on Site with the label mapped to the instance of the Collection" do
      ...
      assert @site.collections["methods"].is_a? Bunto::Collection
    end
    ...
    should "collects docs in an array on the Collection object" do
      ...
      @site.collections["methods"].docs.each do |doc|
        assert doc.is_a? Bunto::Document
        assert_includes %w[
