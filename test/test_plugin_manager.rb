...
class TestPluginManager < BuntoUnitTest
  ...
  def test_requiring_from_bundler
    with_env("BUNTO_NO_BUNDLER_REQUIRE", nil) do
      assert Bunto::PluginManager.require_from_bundler, 'require_from_bundler should return true.'
  ...
  def test_blocking_requiring_from_bundler
    with_env("BUNTO_NO_BUNDLER_REQUIRE", "true") do
      assert_equal false, Bunto::PluginManager.require_from_bundler, "Gemfile plugins were required but shouldn't have been"
