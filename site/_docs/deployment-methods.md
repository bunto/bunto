...
To publish your site, run `storm init` from the root of your project and enter `_site` as the project path when prompted. You can the run `bunto build` to build your site and then run `storm deploy` to publish your site in seconds.
...
You can also use the [Nitrous Bunto Template](https://www.nitrous.io/quickstarts) to develop your Bunto project and deploy to PubStorm directly from Nitrous. This is a great option for developing Bunto projects on Windows.
