...
module Bunto
  class Configuration < Hash
    ...
    def config_files(override)
      # Be quiet quickly.
      Bunto.logger.log_level = :error if quiet?(override)
    ...
    def backwards_compatibilize
      ...
      if config.key? 'server_port'
        Bunto::Deprecator.deprecation_message "The 'server_port' configuration option" +
      ...
      if config.fetch('markdown', 'kramdown').to_s.downcase.eql?("maruku")
        Bunto::Deprecator.deprecation_message "You're using the 'maruku' " +
