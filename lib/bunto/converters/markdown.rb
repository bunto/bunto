module Bunto
  module Converters
    class Markdown < Converter
        ...
        @parser =
          case @config['markdown'].downcase
            ...
            if allowed_custom_class?(@config['markdown'])
              ...
              Bunto.logger.error "Invalid Markdown Processor:", "#{@config['markdown']}"
              Bunto.logger.error "", "Valid options are [ #{valid_processors.join(" | ")} ]"
      ...
      # and is defined within Bunto::Converters::Markdown
