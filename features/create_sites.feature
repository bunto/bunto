Feature: Create sites
  ...
  Scenario: Blank site
    ...
    When I run bunto new test_blank --blank
  ...
  Scenario: Basic site with include tag
    ...
    And I have an "_includes/about.textile" file that contains "Generated by Bunto"
    When I run bunto build
    Then I should get a zero exit status
    And the _site directory should exist
    And I should see "Basic Site with include tag: Generated by Bunto" in "_site/index.html"
  ...
  Scenario: Basic site with subdir include tag
    ...
    Then I should get a zero exit status
    And the _site directory should exist
    And I should see "Basic Site with subdir include tag: Generated by Bunto" in "_site/info/index.html"

  Scenario: Basic site with nested include tag
    Given I have a _includes directory
    And I have an "_includes/about.textile" file that contains "Generated by {% include bunto.textile %}"
    And I have an "_includes/bunto.textile" file that contains "Bunto"
    And I have an "index.html" page that contains "Basic Site with include tag: {% include about.textile %}"
    When I run bunto build
    Then I should get a zero exit status
    And the _site directory should exist
  ...
  Scenario: Basic site with unpublished page
    ...
    When I run bunto build --unpublished
    Then I should get a zero exit status
    And the _site directory should exist
    And the "_site/index.html" file should exist
    And the "_site/public.html" file should exist
