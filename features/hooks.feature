Feature: Hooks
  ...
  Scenario: Run some code after site reset
    ...
    Bunto::Hooks.register :site, :after_reset do |site|
      pageklass = Class.new(Bunto::Page) do
  ...
  Scenario: Modify the payload before rendering the site
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :site, :pre_render do |site, payload|
  ...
  Scenario: Modify the site contents after reading
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :site, :post_read do |site|
  ...
  Scenario: Work with the site files after they've been written to disk
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :site, :post_write do |site|
  ...
  Scenario: Alter a page right after it is initialized
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :pages, :post_init do |page|
  ...
  Scenario: Alter the payload for one page but not another
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :pages, :pre_render do |page, payload|
  ...
  Scenario: Modify page contents before writing to disk
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :pages, :post_render do |page|
  ...
  Scenario: Work with a page after writing it to disk
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :pages, :post_write do |page|
      require 'fileutils'
  ...
  Scenario: Alter a post right after it is initialized
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :posts, :post_init do |post|
  ...
  Scenario: Alter the payload for certain posts
    ...
    # others
    Bunto::Hooks.register :posts, :pre_render do |post, payload|
  ...
  Scenario: Work with a post after writing it to disk
    ...
    Bunto::Hooks.register :posts, :post_write do |post|
  ...
  Scenario: Register a hook on multiple owners at the same time
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register [:pages, :posts], :post_render do |owner|
  ...
  Scenario: Allow hooks to have a named priority
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :pages, :post_render, priority: :normal do |owner|
      # first normal runs second
      owner.output = "1 #{owner.output.chomp}"
    end
    Bunto::Hooks.register :pages, :post_render, priority: :high do |owner|
      # high runs first
      owner.output = "2 #{owner.output.chomp}"
    end
    Bunto::Hooks.register :pages, :post_render do |owner|
      # second normal runs third (normal is default)
      owner.output = "3 #{owner.output.chomp}"
    end
    Bunto::Hooks.register :pages, :post_render, priority: :low do |owner|
      # low runs last 
  ...
  Scenario: Alter a document right after it is initialized
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :documents, :pre_render do |doc, payload|
  ...
  Scenario: Update a document after rendering it, but before writing it to disk
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :documents, :post_render do |doc|
  ...
  Scenario: Perform an action after every document is written
    ...
    And I have a "_plugins/ext.rb" file with content:
    """
    Bunto::Hooks.register :documents, :post_write do |doc|
