Feature: Collections
  ...
  Scenario: Sort by relative_path
    ...
    Then I should get a zero exit status
    Then the _site directory should exist
    And I should see "Collections: Collection#entries, Bunto.configuration, Bunto.escape, Bunto.sanitized_path, Site#generate, Initialize, Site#generate," in "_site/index.html"
