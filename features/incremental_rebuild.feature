Feature: Incremental rebuild
  ...
  Scenario: Generate a metadata file
    ...
    When I run bunto build
    Then the ".bunto-metadata" file should exist
  ...
  Scenario: Rebuild when layout is changed
    ...
    When I run bunto build --full-rebuild
    Then the _site directory should exist
  ...
  Scenario: Rebuild when an include is changed
    ...
    When I wait 1 second
    Then I have an "_includes/about.textile" file that contains "Regenerated by Bunto"
    When I run bunto build
    Then the _site directory should exist
    And I should see "Basic Site with include tag: Regenerated by Bunto" in "_site/index.html"
