...
- Write Bunto::Utils::Exec.run for running shell commands. ([#5640]({{ site.repository }}/issues/5640))
...
- Rubocop -a on lib/bunto ([#5666]({{ site.repository }}/issues/5666))
...
- Sort gems in `bunto.gemspec` ([#5746]({{ site.repository }}/issues/5746))
...
- Add Bunto-Post to list of plugins ([#5705]({{ site.repository }}/issues/5705))
- Add bunto-numbered-headings ([#5688]({{ site.repository }}/issues/5688))
...
- Remove instructions to install Bunto 2 on Windows ([#5582]({{ site.repository }}/issues/5582))
...
- Add bunto-migrate-permalink ([#5600]({{ site.repository }}/issues/5600))
...
- Add bunto-pre-commit to plugins list ([#5752]({{ site.repository }}/issues/5752))
...
- Add missing merge labels for buntobot ([#5753]({{ site.repository }}/issues/5753))
...
- `bunto new-theme` should specify Bunto as a runtime dependency for the theme ([#5457]({{ site.repository }}/issues/5457))
...
- Updating install instruction link for Bunto 3 on Windows ([#5475]({{ site.repository }}/issues/5475))
- Update normalize.css to v5.0.0 ([#5471]({{ site.repository }}/issues/5471))
- Add bunto-data to the list of plugins ([#5491]({{ site.repository }}/issues/5491))
- Add info about checking version + updating ([#5497]({{ site.repository }}/issues/5497))
- Add bunto-include-absolute-plugin to list of third-party plugins ([#5492]({{ site.repository }}/issues/5492))
- Remove bunto-hook from deployment methods ([#5502]({{ site.repository }}/issues/5502))
...
- Update documentation on buntowaf.tk ([#5540]({{ site.repository }}/issues/5540))
...
- Add bunto-pinboard to list of third-party plugins ([#5514]({{ site.repository }}/issues/5514))
...
- Fix link to bunto-pinboard plugin ([#5570]({{ site.repository }}/issues/5570))
...
- Add bundle install to bunto new command ([#5237]({{ site.repository }}/issues/5237))
...
- Use bunto-feed to generate the default site's RSS feed ([#5196]({{ site.repository }}/issues/5196))
...
- Site template config: prepend 'bunto serve' with 'bundle exec' ([#5430]({{ site.repository }}/issues/5430))
...
- Fix issue where Windows drive name is stripped from Bunto.sanitized_path incorrectly ([#5256]({{ site.repository }}/issues/5256))
...
- Add the Bunto Cloudinary plugin ([#5183]({{ site.repository }}/issues/5183))
...
- Add post about Bunto Admin initial release ([#5291]({{ site.repository }}/issues/5291))
- Replace liquid highlight tag with backticks ([#5262]({{ site.repository }}/issues/5262))
- Word update ([#5294]({{ site.repository }}/issues/5294))
- Site documentation section links always point to https://buntowaf.tk ([#5281]({{ site.repository }}/issues/5281))
...
- added bunto-spotify plugin ([#5369]({{ site.repository }}/issues/5369))
- Add bunto-menus to the list of plugins. ([#5397]({{ site.repository }}/issues/5397))
...
- [docs] Update documentation regarding `bundle install` after `bunto new` ([#5428]({{ site.repository }}/issues/5428))
...
- Add Bunto 3.3 release post ([#5442]({{ site.repository }}/issues/5442))

### Development Fixes
{: #development-fixes-v3-3-0}

- Update appveyor.yml and fix optional deps for Ruby x64 ([#5180]({{ site.repository }}/issues/5180))
- Improve tests for Bunto::PluginManager ([#5167]({{ site.repository }}/issues/5167))
...
- Execute bunto from clone instead of defined binary when running 'script/default-site' ([#5295]({{ site.repository }}/issues/5295))
- rubocop: lib/bunto/document.rb complexity fixes ([#5045]({{ site.repository }}/issues/5045))
...
- swallow bundle output from `bunto new` while in CI ([#5408]({{ site.repository }}/issues/5408))
...
- script/default-site: read Bunto source from local clone ([#5188]({{ site.repository }}/issues/5188))
...
- 'bunto clean': also remove .sass-cache ([#4652]({{ site.repository }}/issues/4652))
...
- Globalize Bunto's Filters. ([#4792]({{ site.repository }}/issues/4792))
...
- Add 'bunto new-theme' command to help users get up and running creating a theme ([#4848]({{ site.repository }}/issues/4848))
- `markdownify` and `smartify` should convert input to string before conversion ([#4958]({{ site.repository }}/issues/4958))
- Run `Site#generate` for 'bunto doctor' to catch plugin issues ([#5005]({{ site.repository }}/issues/5005))
- Add `normalize_whitepace` filter ([#4917]({{ site.repository }}/issues/4917))
- Move bin/bunto to exe/bunto to prevent collision with binstubs ([#5014]({{ site.repository }}/issues/5014))
...
- Fixing rubocop offenses in lib/bunto/cleaner.rb ([#4892]({{ site.repository }}/issues/4892))
- Update `bunto/commands*` to pass rubocop rules ([#4888]({{ site.repository }}/issues/4888))
...
- Rubocop: lib/bunto/entry_filter.rb ([#4950]({{ site.repository }}/issues/4950))
...
- rubocop: bunto/lib/frontmatter_defaults.rb ([#4974]({{ site.repository }}/issues/4974))
- rubocop: features/step_definitions.rb ([#4956]({{ site.repository }}/issues/4956))
- Rubocop theme and url bunto libs ([#4959]({{ site.repository }}/issues/4959))
- Rubocop bunto.rb ([#4966]({{ site.repository }}/issues/4966))
...
- Rubocop: bunto/lib/site.rb ([#4973]({{ site.repository }}/issues/4973))
- Add timings for each scenario in cucumber & print worst offenders ([#4908]({{ site.repository }}/issues/4908))
- rubocop: bunto/lib/filters.rb ([#4993]({{ site.repository }}/issues/4993))
- Fix rubocop offenses in exe/bunto ([#5017]({{ site.repository }}/issues/5017))
- Rubocop: lib/bunto/command.rb ([#5018]({{ site.repository }}/issues/5018))
- rubocop: lib/bunto/static_file.rb ([#5019]({{ site.repository }}/issues/5019))
- rubocop: lib/bunto/utils.rb ([#5026]({{ site.repository }}/issues/5026))
- rubocop: lib/bunto/regenerator.rb ([#5025]({{ site.repository }}/issues/5025))
- rubocop: lib/bunto/configuration.rb ([#5024]({{ site.repository }}/issues/5024))
- rubocop: lib/bunto/renderer.rb style fixes ([#5032]({{ site.repository }}/issues/5032))
- rubocop: lib/bunto/convertible.rb style fixes ([#5031]({{ site.repository }}/issues/5031))
- rubocop: lib/bunto/document.rb style fixes ([#5030]({{ site.repository }}/issues/5030))
...
- Internal documentation for working on Bunto ([#5011]({{ site.repository }}/issues/5011))
- rubocop: lib/bunto/collection.rb ([#5022]({{ site.repository }}/issues/5022))
...
- Add bunto-seo-tag, bunto-avatar, and bunto-sitemap to the site ([#4553]({{ site.repository }}/issues/4553))
...
- Add bunto-video-embed to list of third-party plugins. ([#4621]({{ site.repository }}/issues/4621))
...
- Add bunto-paspagon plugin ([#4700]({{ site.repository }}/issues/4700))
...
- Add bunto-i18n_tags to list of third-party plugins ([#4775]({{ site.repository }}/issues/4775))
...
- Update Rack-Bunto Heroku deployment blog post url ([#4789]({{ site.repository }}/issues/4789))
...
- Add bunto-breadcrumbs to list of third-party plugins ([#4874]({{ site.repository }}/issues/4874))
- Added Pug converter to list of third-party plugins ([#4872]({{ site.repository }}/issues/4872))
- Add bunto-ideal-image-slider to list of third-party plugins ([#4863]({{ site.repository }}/issues/4863))
- Add Bunto Tips and the Cheatsheet to the list of resources ([#4887]({{ site.repository }}/issues/4887))
...
- Add bunto-tags-list-plugin to list of third-party plugins ([#5000]({{ site.repository }}/issues/5000))
...
- Add generator-buntoized to third-party plugins ([#5027]({{ site.repository }}/issues/5027))
- Add Bunto Art Hallery generator plugin to list of third-party plugins ([#5043]({{ site.repository }}/issues/5043))
- Add Formingo to the list of Bunto form SaaS ([#5054]({{ site.repository }}/issues/5054))
...
- Bunto Community ([#5097]({{ site.repository }}/issues/5097))
...
- docs: add bunto-maps plugin reference ([#5123]({{ site.repository }}/issues/5123))
...
- `Bunto.sanitized_path`: sanitizing a questionable path should handle tildes ([#4492]({{ site.repository }}/issues/4492))
...
- Add bunto-toc plugin ([#4429]({{ site.repository }}/issues/4429))
...
- [add note] Bunto 3 requires newer version of Ruby. ([#4461]({{ site.repository }}/issues/4461))
- Fix typo in upgrading docs ([#4473]({{ site.repository }}/issues/4473))
- Add note about upgrading documentation on buntowaf.tk/help/ ([#4484]({{ site.repository }}/issues/4484))
...
- Added amp-bunto plugin to plugins docs ([#4517]({{ site.repository }}/issues/4517))
...
- General improvements for WEBrick via bunto serve such as SSL & custom headers ([#4224]({{ site.repository }}/issues/4224), [#4228]({{ site.repository }}/issues/4228))
...
- Add a Bunto doctor warning for URLs that only differ by case ([#3171]({{ site.repository }}/issues/3171))
...
- Make sure bunto/drops/drop is loaded first. ([#4292]({{ site.repository }}/issues/4292))
...
- `bunto-docs` should be easily release-able ([#4152]({{ site.repository }}/issues/4152))
...
- Change TestDoctorCommand to BuntoUnitTest... ([#4263]({{ site.repository }}/issues/4263))
...
- Add `bunto-deploy` to list of third-party plugins ([#4179]({{ site.repository }}/issues/4179))
...
- Update FormKeep link to be something more specific to Bunto ([#4243]({{ site.repository }}/issues/4243))
...
- Add bunto-paginate-category to list of third-party plugins ([#4273]({{ site.repository }}/issues/4273))
- Add `bunto-responsive_image` to list of third-party plugins ([#4286]({{ site.repository }}/issues/4286))
- Add `bunto-commonmark` to list of third-party plugins ([#4299]({{ site.repository }}/issues/4299))
...
- Fixed broken link to blog on using mathjax with bunto ([#4344]({{ site.repository }}/issues/4344))
...
- Added the Wordpress2Bunto Wordpress plugin ([#4377]({{ site.repository }}/issues/4377))
...
- `Bunto.sanitized_path`: escape tildes before sanitizing a questionable path ([#4468]({{ site.repository }}/issues/4468))
...
- Don't generate `.bunto-metadata` in non-incremental build ([#4079]({{ site.repository }}/issues/4079))
...
- Adds a note about installing the bunto-gist gem to make gist tag work ([#4101]({{ site.repository }}/issues/4101))
- Align hooks documentation with implementation ([#4104]({{ site.repository }}/issues/4104))
- Add Bunto Flickr Plugin to the list of third party plugins ([#4111]({{ site.repository }}/issues/4111))
...
- Add bunto-language-plugin to plugins.md ([#4134]({{ site.repository }}/issues/4134))
...
- Add a Code of Conduct for the Bunto project ([#3925]({{ site.repository }}/issues/3925))
...
- Separate `bunto docs` and optimize external gem handling ([#3241]({{ site.repository }}/issues/3241))
...
- Split off Textile support into bunto-textile-converter ([#3319]({{ site.repository }}/issues/3319))
...
- Add `pkill -f bunto` to ways to kill. ([#3397]({{ site.repository }}/issues/3397))
...
- Removed the word 'Bunto' a few times from the comments ([#3617]({{ site.repository }}/issues/3617))
- `bin/bunto`: with no args, exit with exit code 1 ([#3619]({{ site.repository }}/issues/3619))
...
- Use `Bunto::Post`s for both LSI indexing and lookup. ([#3629]({{ site.repository }}/issues/3629))
...
- Perf: `Bunto::Cleaner#existing_files`: Call `keep_file_regex` and `keep_dirs` only once, not once per iteration ([#3696]({{ site.repository }}/issues/3696))
- Omit bunto/bunto-help from list of resources. ([#3698]({{ site.repository }}/issues/3698))
- Add basic `bunto doctor` test to detect fsnotify (OSX) anomalies. ([#3704]({{ site.repository }}/issues/3704))
- Added talk.buntowaf.tk to "Have questions?" ([#3694]({{ site.repository }}/issues/3694))
...
- Perform bunto-paginate deprecation warning correctly. ([#3580]({{ site.repository }}/issues/3580))
...
- Ignore `.bunto-metadata` in site template ([#3496]({{ site.repository }}/issues/3496))
...
- Add WOFF2 font MIME type to Bunto server MIME types ([#3647]({{ site.repository }}/issues/3647))
...
- Open `.bunto-metadata` in binary mode to read binary Marshal data ([#3713]({{ site.repository }}/issues/3713))
...
- Read build options for `bunto clean` command ([#3828]({{ site.repository }}/issues/3828))
...
- Fix comment typo in `lib/bunto/frontmatter_defaults.rb` ([#3322]({{ site.repository }}/issues/3322))
...
- Added tests for `Bunto:StaticFile` ([#3633]({{ site.repository }}/issues/3633))
...
- Add blog post announcing Bunto Help ([#3523]({{ site.repository }}/issues/3523))
- Add Bunto Talk to Help page on site ([#3518]({{ site.repository }}/issues/3518))
...
- Add `bunto-thumbnail-filter` to list of third-party plugins ([#2790]({{ site.repository }}/issues/2790))
- Add link to 'Adding Ajax pagination to Bunto' to Resources page ([#3186]({{ site.repository }}/issues/3186))
...
- Add `bunto-minifier` to list of third-party plugins ([#3333]({{ site.repository }}/issues/3333))
- Add blog post about the Bunto meet-up ([#3332]({{ site.repository }}/issues/3332))
...
- Release buntowaf.tk as a locally-compiled site. ([#3426]({{ site.repository }}/issues/3426))
- Add a buntowaf.tk/help page which elucidates places from which to get help ([#3428]({{ site.repository }}/issues/3428))
...
- Add bunto-auto-image generator to the list of third-party plugins ([#3489]({{ site.repository }}/issues/3489))
...
- Add information about the `.bunto-metadata` file ([#3597]({{ site.repository }}/issues/3597))
- Document addition of variable parameters to an include ([#3581]({{ site.repository }}/issues/3581))
- Add `bunto-files` to the list of third-party plugins. ([#3586]({{ site.repository }}/issues/3586))
...
- Upgrade pieces of the Ugrading guide for Bunto 3 ([#3607]({{ site.repository }}/issues/3607))
...
- Update the link in the welcome post to point to Bunto Talk ([#3745]({{ site.repository }}/issues/3745))
- Update link for navbars with data attributes tutorial ([#3728]({{ site.repository }}/issues/3728))
- Add `bunto-asciinema` to list of third-party plugins ([#3750]({{ site.repository }}/issues/3750))
...
- Add Bunto Portfolio Generator to list of plugins ([#3883]({{ site.repository }}/issues/3883))
...
- Add `bunto-youtube` to the list of third-party plugins ([#3931]({{ site.repository }}/issues/3931))
...
- Use Bunto Feed for buntowaf.tk ([#3736]({{ site.repository }}/issues/3736))
...
- Added documentation for Bunto environment variables ([#3989]({{ site.repository }}/issues/3989))
...
- Add alternative bunto gem installation instructions ([#4018]({{ site.repository }}/issues/4018))
...
- Add bunto-smartify to the list of third-party plugins ([#3572]({{ site.repository }}/issues/3572))
...
- Add `[@alfredxing](https://github.com/alfredxing)` to the `[@bunto](https://github.com/bunto)/core` team. :tada: ([#3218]({{ site.repository }}/issues/3218))
...
- Add bunto-500px-embed to list of third-party plugins ([#3163]({{ site.repository }}/issues/3163))
- Simplified platform detection in Gemfile example for Windows ([#3177]({{ site.repository }}/issues/3177))
- Add the `bunto-jalali` plugin added to the list of third-party plugins. ([#3198]({{ site.repository }}/issues/3198))
...
- Add `bunto-mermaid` plugin to list of third-party plugins ([#3222]({{ site.repository }}/issues/3222))
...
- Fix bundle require for `:bunto_plugins` ([#3119]({{ site.repository }}/issues/3119))
...
- Slightly compress bunto-sticker.jpg. ([#3133]({{ site.repository }}/issues/3133))
...
- Require gems in `:bunto_plugins` Gemfile group unless `BUNTO_NO_BUNDLER_REQUIRE` is specified in the environment. ([#2865]({{ site.repository }}/issues/2865))
...
- Allow users to specify the log level via `BUNTO_LOG_LEVEL`. ([#3067]({{ site.repository }}/issues/3067))
...
- In the case that a Gemfile does not exist, ensure Bunto doesn't fail on requiring the Gemfile group ([#3066]({{ site.repository }}/issues/3066))

### Development Fixes
{: #development-fixes-v2-5-0}

- Fix a typo in the doc block for `Bunto::URL.escape_path` ([#3052]({{ site.repository }}/issues/3052))
- Add integration test for `bunto new --blank` in TestUnit ([#2913]({{ site.repository }}/issues/2913))
- Add unit test for `bunto new --force` logic ([#2929]({{ site.repository }}/issues/2929))
...
- Add FormKeep to resources as Bunto form backend ([#3010]({{ site.repository }}/issues/3010))
...
- Add 'Bunto Twitter Plugin' to list of third-party plugins ([#2979]({{ site.repository }}/issues/2979))
...
- Use `Bunto.sanitized_path` when adding static files to Collections ([#2849]({{ site.repository }}/issues/2849))
...
- Adds info about installing bunto in current dir ([#2839]({{ site.repository }}/issues/2839))
- Remove deprecated `bunto-projectlist` plugin from list of third-party plugins ([#2742]({{ site.repository }}/issues/2742))
- Remove tag plugins that are built in to Bunto ([#2751]({{ site.repository }}/issues/2751))
...
- Add `bunto help` command ([#2707]({{ site.repository }}/issues/2707))
...
- Refactor based on bunto-watch clean-up. ([#2716]({{ site.repository }}/issues/2716))
...
- Add link to `bunto-slim` in list of third-party plugins ([#2689]({{ site.repository }}/issues/2689))
...
- Remove unnecessary `Bunto::Tags::IncludeTag#blank?` method ([#2625]({{ site.repository }}/issues/2625))
...
- Add `Bunto::AutolinkEmail` and `Bunto::GitMetadata` to the list of third-party plugins ([#2596]({{ site.repository }}/issues/2596))
...
- Add bunto-hook to deployment methods ([#2617]({{ site.repository }}/issues/2617))
...
- Add `Bunto.env` and `bunto.environment` (the Liquid var) ([#2417]({{ site.repository }}/issues/2417))
...
- Extract Pagination Generator into gem: `bunto-paginate` ([#2455]({{ site.repository }}/issues/2455))
...
- Fix a bit of missing TomDoc to `Bunto::Commands::Build#build` ([#2554]({{ site.repository }}/issues/2554))
...
- Add `bunto_github_sample` plugin to list of third-party plugins ([#2463]({{ site.repository }}/issues/2463))
...
- Add Bunto Project Version Tag to list of third-party plugins ([#2468]({{ site.repository }}/issues/2468))
- Use `https` for GitHub links across whole site ([#2470]({{ site.repository }}/issues/2470))
- Add StickerMule + Bunto post ([#2476]({{ site.repository }}/issues/2476))
- Add Bunto Asset Pipeline Reborn to list of third-party plugins ([#2479]({{ site.repository }}/issues/2479))
- Add link to bunto-compress-html to list of third-party plugins ([#2514]({{ site.repository }}/issues/2514))
...
- Documentation for Continuous Integration for your Bunto Site ([#2432]({{ site.repository }}/issues/2432))
...
- `Bunto::Filters#time` now accepts UNIX timestamps in string or number form ([#2339]({{ site.repository }}/issues/2339))
...
- Move to bunto/bunto from mojombo/bunto ([#1817]({{ site.repository }}/issues/1817))
...
- Complete redesign of the template site generated by `bunto new` ([#2050]({{ site.repository }}/issues/2050))
...
- Move the EntryFilter class into the Bunto module to avoid polluting the global namespace ([#1800]({{ site.repository }}/issues/1800))
...
- Bring MIME Types file for `bunto serve` to complete parity with GH Pages servers ([#1993]({{ site.repository }}/issues/1993))
...
- Add `Bunto::LiquidExtensions` with `.lookup_variable` method for easy looking up of variable values in a Liquid context. ([#2253]({{ site.repository }}/issues/2253))
...
- Add `#path` to required methods in `Bunto::Convertible` ([#1866]({{ site.repository }}/issues/1866))
- Default Maruku fenced code blocks to ON for 2.0.0-dev ([#1831]({{ site.repository }}/issues/1831))
- Change short opts for host and port for `bunto docs` to be consistent with other subcommands ([#1877]({{ site.repository }}/issues/1877))
...
- Remove obsolete `normalize_options` method call from `bin/bunto` ([#2121]({{ site.repository }}/issues/2121))
...
- Only use Bunto.logger for output ([#2307]({{ site.repository }}/issues/2307))
...
- Test Bunto under Ruby 2.1.0 ([#1900]({{ site.repository }}/issues/1900))
...
- Streamline Cucumber execution of `bunto` subcommands ([#2258]({{ site.repository }}/issues/2258))
...
- Add bunto-compass to the plugin list ([#1923]({{ site.repository }}/issues/1923))
...
- Add `bunto-humanize` plugin to plugin list ([#1998]({{ site.repository }}/issues/1998))
- Add `bunto-font-awesome` plugin to plugin list ([#1999]({{ site.repository }}/issues/1999))
- Add `sublime-bunto` to list of Editor plugins ([#2001]({{ site.repository }}/issues/2001))
- Add `vim-bunto` to the list of Editor plugins ([#2005]({{ site.repository }}/issues/2005))
...
- Update link to rack-bunto on "Deployment Methods" page ([#2047]({{ site.repository }}/issues/2047))
...
- Add Bunto Pages Directory plugin to list of plugins ([#2096]({{ site.repository }}/issues/2096))
- Update Configuration docs page with new markdown extension ([#2102]({{ site.repository }}/issues/2102))
- Add `bunto-image-set` to the list of third-party plugins ([#2105]({{ site.repository }}/issues/2105))
...
- Add `bunto-ordinal` to list of third-party plugins ([#2150]({{ site.repository }}/issues/2150))
- Add `bunto_figure` to list of third-party plugins ([#2158]({{ site.repository }}/issues/2158))
...
- Add `bunto-page-collections` to list of third-party plugins ([#2215]({{ site.repository }}/issues/2215))
- Add a cross-reference about `post_url` ([#2243]({{ site.repository }}/issues/2243))
- Add `bunto-live-tiles` to list of third-party plugins ([#2250]({{ site.repository }}/issues/2250))
- Fixed broken link to GitHub training material site source ([#2257]({{ site.repository }}/issues/2257))
- Update link to help repo, now called `bunto-help` ([#2277]({{ site.repository }}/issues/2277))
- Fix capitalization of 'Bunto' on Deployment Methods page ([#2291]({{ site.repository }}/issues/2291))
...
- Fixed case of a word in the Bunto v1.3.0 release post ([#1762]({{ site.repository }}/issues/1762))
...
- Add `bunto-monthly-archive-plugin` and `bunto-category-archive-plugin` to list of third-party plugins ([#1693]({{ site.repository }}/issues/1693))
- Add `bunto-asset-path-plugin` to list of third-party plugins ([#1670]({{ site.repository }}/issues/1670))
- Add `emoji-for-bunto` to list of third-part plugins ([#1708]({{ site.repository }}/issues/1708))
...
- Point "Blog migrations" page to http://import.buntowaf.tk ([#1732]({{ site.repository }}/issues/1732))
...
- Provide better error handling for Bunto's custom Liquid tags ([#1514]({{ site.repository }}/issues/1514))
...
- Point people to the migration docs when the `bunto-import` gem is missing ([#1662]({{ site.repository }}/issues/1662))
...
- Fix params for `BuntoImport::WordPress.process` arguments ([#1554]({{ site.repository }}/issues/1554))
- Add `bunto-suggested-tweet` to list of third-party plugins ([#1555]({{ site.repository }}/issues/1555))
...
- Add `bunto-import` warning note of missing dependencies ([#1626]({{ site.repository }}/issues/1626))
...
- Disable reverse lookup when running `bunto serve` ([#1363]({{ site.repository }}/issues/1363))
...
- Add checking for URL conflicts when running `bunto doctor` ([#1389]({{ site.repository }}/issues/1389))

### Minor Enhancements
{: #minor-enhancements-v1-2-0}

- Catch and fix invalid `paginate` values ([#1390]({{ site.repository }}/issues/1390))
- Remove superfluous `div.container` from the default html template for `bunto new` ([#1315]({{ site.repository }}/issues/1315))
...
- Add the ability to detach the server ran by `bunto serve` from it's controlling terminal ([#1443]({{ site.repository }}/issues/1443))
- Improve permalink generation for URLs with special characters ([#944]({{ site.repository }}/issues/944))
- Expose the current Bunto version to posts and pages via a new `bunto.version` variable ([#1481]({{ site.repository }}/issues/1481))
...
- Remove redundant argument to Bunto::Commands::New#scaffold_post_content ([#1356]({{ site.repository }}/issues/1356))
...
- Refactor `Site#cleanup` into `Bunto::Site::Cleaner` class ([#1429]({{ site.repository }}/issues/1429))
- Several other small minor refactorings ([#1341]({{ site.repository }}/issues/1341))
- Ignore `_site` in buntowaf.tk deploy ([#1480]({{ site.repository }}/issues/1480))
...
- Update plugin list with bunto-rss plugin ([#1354]({{ site.repository }}/issues/1354))
- Update the site list page with Ruby's official site ([#1358]({{ site.repository }}/issues/1358))
- Add `bunto-ditaa` to list of third-party plugins ([#1370]({{ site.repository }}/issues/1370))
...
- Update the docs for Redcarpet in Bunto ([#1418]({{ site.repository }}/issues/1418))
...
- Use `site.repository` for Bunto's GitHub URL ([#1463]({{ site.repository }}/issues/1463))
- Add `bunto-pageless-redirects` to list of third-party plugins ([#1486]({{ site.repository }}/issues/1486))
- Clarify that `date_to_xmlschema` returns an ISO 8601 string ([#1488]({{ site.repository }}/issues/1488))
- Add `bunto-good-include` to list of third-party plugins ([#1491]({{ site.repository }}/issues/1491))
- XML escape the blog post title in our feed ([#1501]({{ site.repository }}/issues/1501))
- Add `bunto-toc-generator` to list of third-party plugins ([#1506]({{ site.repository }}/issues/1506))
...
- Remove superfluous `table` selector from main.css in `bunto new` template ([#1328]({{ site.repository }}/issues/1328))
...
- Add Bunto Image Tag to the plugins list ([#1306]({{ site.repository }}/issues/1306))
...
- Add generator-buntorb and grunt-bunto to plugins page ([#1330]({{ site.repository }}/issues/1330))
...
- Change filename in `include` example to an HTML file so as not to indicate that Bunto will automatically convert them. ([#1303]({{ site.repository }}/issues/1303))
- Add an RSS feed for commits to Bunto ([#1343]({{ site.repository }}/issues/1343))
...
- Add `docs` subcommand to read Bunto's docs when offline. ([#1046]({{ site.repository }}/issues/1046))
...
- Add the ability to generate a new Bunto site without a template ([#1171]({{ site.repository }}/issues/1171))
...
- Add `redcarpet` as a runtime dependency so `bunto build` works out-of-the-box for new sites. ([#1247]({{ site.repository }}/issues/1247))
...
- Refactor Bunto::Site ([#1144]({{ site.repository }}/issues/1144))
...
- Remove plugins from the plugin list that have equivalents in Bunto proper ([#1223]({{ site.repository }}/issues/1223))
- Add bunto-assets to the plugin list ([#1225]({{ site.repository }}/issues/1225))
- Add bunto-pandoc-mulitple-formats to the plugin list ([#1229]({{ site.repository }}/issues/1229))
...
- Specify that RedCarpet is the default for new Bunto sites on Quickstart page ([#1247]({{ site.repository }}/issues/1247))
...
- Add `bunto-timeago` to list of third-party plugins. ([#1260]({{ site.repository }}/issues/1260))
- Add `bunto-swfobject` to list of third-party plugins. ([#1263]({{ site.repository }}/issues/1263))
- Add `bunto-picture-tag` to list of third-party plugins. ([#1280]({{ site.repository }}/issues/1280))
...
- Add a `--force` option to `bunto new` ([#1115]({{ site.repository }}/issues/1115))
...
- Rename Bunto::Logger to Bunto::Stevenson to fix inheritance issue ([#1106]({{ site.repository }}/issues/1106))
- Exit with a non-zero exit code when dealing with a Liquid error ([#1121]({{ site.repository }}/issues/1121))
- Make the `exclude` and `include` options backwards compatible with versions of Bunto prior to 1.0 ([#1114]({{ site.repository }}/issues/1114))
...
- Add link to bunto-minibundle in the doc's plugins list ([#1035]({{ site.repository }}/issues/1035))
- Quick patch for importers documentation
- Fix prefix for WordpressDotCom importer in docs ([#1107]({{ site.repository }}/issues/1107))
- Add bunto-contentblocks plugin to docs ([#1068]({{ site.repository }}/issues/1068))
...
- Add the Bunto Gallery Plugin to the plugin list ([#1143]({{ site.repository }}/issues/1143))

### Development Fixes
{: #development-fixes-v1-0-3}

- Use Bunto.logger instead of Bunto::Stevenson to log things ([#1149]({{ site.repository }}/issues/1149))
...
- Add `bunto doctor` command to check site for any known compatibility problems ([#1081]({{ site.repository }}/issues/1081))
...
- Update links on README to point to new buntowaf.tk ([#1018]({{ site.repository }}/issues/1018))
...
- Add `bunto new` subcommand: generate a Bunto scaffold ([#764]({{ site.repository }}/issues/764))
- Refactored Bunto commands into subcommands: build, serve, and migrate. ([#690]({{ site.repository }}/issues/690))
- Removed importers/migrators from main project, migrated to bunto-import sub-gem ([#793]({{ site.repository }}/issues/793))
...
- Freak out if the destination of `bunto new` exists and is non-empty ([#981]({{ site.repository }}/issues/981))
...
- Load in GitHub Pages MIME Types on `bunto serve` ([#847]({{ site.repository }}/issues/847), [#871]({{ site.repository }}/issues/871))
...
- New format of Bunto output ([#795]({{ site.repository }}/issues/795))
...
- Aliased `bunto server` to `bunto serve`. ([#792]({{ site.repository }}/issues/792))
- Updated gem versions for Kramdown, Rake, Shoulda, Cucumber, and RedCarpet. ([#744]({{ site.repository }}/issues/744))
- Refactored Bunto subcommands into Bunto::Commands submodule, which now contains them ([#768]({{ site.repository }}/issues/768))
...
- Accepting strings as arguments to bunto-import command ([#910]({{ site.repository }}/issues/910))
...
- Patch for multibyte URI problem with `bunto serve` ([#723]({{ site.repository }}/issues/723))
...
- Add SVG support to Bunto/WEBrick. ([#407]({{ site.repository }}/issues/407), [#406]({{ site.repository }}/issues/406))
...
- Bug Fixes
- Add Bunto binary as executable to gemspec ([@dysinger](https://github.com/dysinger))
...
- Bug Fixes
- Prevent Bunto from picking up the output directory as a source ([@JackDanger](https://github.com/JackDanger))
